 ...
 */
$config['DEBUG'] = 0;
$config['SALT'] = md5("changeme");
$config['SALTY'] = md5("changeme2");
...
$config['gettingstarted']['coinurl'] = 'http://www.dogecoin.com';
