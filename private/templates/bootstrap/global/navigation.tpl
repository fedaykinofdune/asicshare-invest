       <nav class="navbar-default navbar-static-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="side-menu">
                    ...
                    {/if}
                    <!-- Lock it down to userid 1 until ready to release -->
                    {if $smarty.session.AUTHENTICATED|default:"0" == 1 && $GLOBAL.userdata.id == 1}
                    <li {if $smarty.get.page|default:"0" eq "investments"}class="active"{/if}>
                        <a href="#"><i class="fa fa-wrench fa-fw"></i>Investments<span class="fa arrow"></span></a>
                        <ul class="nav nav-second-level">
                          <li><a href="{$smarty.server.SCRIPT_NAME}?page=investments&action=dashboard"><i class="fa fa-edit fa-fw"></i> Details</a></li>
                          <li><a href="{$smarty.server.SCRIPT_NAME}?page=investments&action=details"><i class="fa fa-edit fa-fw"></i> Create New</a></li>
                        </ul>
                        <!-- /.nav-second-level -->
                    </li>
                    {/if}
